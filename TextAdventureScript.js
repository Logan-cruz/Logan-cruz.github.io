...
class Class {
  ...
  class Rogue extends Class {
    constructor(name, health, atk, magic, magicAtk, def, magicDef) {
      this.ability = ['Pickpocket', 'Cheap shot', 'Honor among thieves', 'Know thy enemy', 'Trump Card', 'Blind shot']
  ...
  class Paladin extends Class {
    constructor(name, health, atk, magic, magicAtk, def, magicDef) {
      this.ability = ['Holy touch', 'Smite', 'Judgement day', 'Intevention', 'Retribution']
  ...
  class Priest extends Class {
    constructor(name, health, atk, magic, magicAtk, magicDef) {
